  ...
  return (
    <Social>
      <div>
        ...
        <div>
          <a href="https://www.linkedin.com/in/ankur-mishra-a9b0a6223/" target="_blank">
            <img
              style={{
                margin: "5px",
                height: "50px",
        ...
        <div>
          <p className="mobile"> Mobile:- 9770858484</p>
          <p className="mobile"> Email:- ankurmishra710@gmail.com</p>
        </div>
      </div>
